...
public class Perfil_Inicial_Activity extends Activity implements Button.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new Mensagem("Informativo!", "Você deverá registrar um usuário para prosseguir!", "Ok", R.drawable.icone_informativo, Perfil_Inicial_Activity.this);
	...
	private void salvar() {
		...
		if (troca) {
			...
			builder.setMessage("O usuário " + nome.getText().toString()
